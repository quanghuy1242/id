...
export const mockScopes: OAuthResourceScope[] = [
  ...
  },
  {
    ...
    resourceServerId: "rs_001",
    scope: "content:write",
    description: "Write access to content",
    enabled: true,
    createdBy: "user_001",
    updatedBy: "user_001",
    createdAt: seedTime,
  ...
  },
  {
    ...
    resourceServerId: "rs_001",
    scope: "content:admin",
    description: "Admin access to content",
    enabled: false,
    createdBy: "user_001",
    updatedBy: "user_001",
    createdAt: seedTime,
  ...
  {
    id: "sc_004",
    resourceServerId: "rs_002",
    scope: "vendor:read",
    description: "Read access to vendor data",
    enabled: true,
    createdBy: "user_001",
    updatedBy: "user_001",
    createdAt: seedTime,
