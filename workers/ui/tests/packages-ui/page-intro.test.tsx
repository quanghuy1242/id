...
import { Button, PageIntro } from "@id/ui";
...
describe("PageIntro", () => {
  ...
  it("renders the description helper text", () => {
    render(<PageIntro title="Users" description="Manage accounts and roles." />);
  ...
  it("renders an info popover trigger when info is provided", () => {
    ...
    expect(screen.getByRole("button", { name: /about users/i })).toBeInTheDocument();
  });
