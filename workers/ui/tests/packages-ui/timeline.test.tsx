...
describe("Timeline", () => {
  it("renders title, meta, and detail for each item", () => {
    render(
      <Timeline
        items={[
          { id: "1", title: "Secret rotated", meta: "by alice · 14:02", detail: "auth method unchanged" },
  ...
  it("applies the tone class to the marker", () => {
    ...
    expect(container.querySelector(".timeline-middle")).toHaveClass("text-warning");
  });
