...
import { FileDropzone } from "@id/ui";
...
describe("FileDropzone", () => {
  it("renders the label, browse button, and hint", () => {
    render(<FileDropzone label="Upload CSV" onFiles={() => {}} hint="content,scope,description" />);
  ...
  it("calls onFiles when a file is selected", () => {
    ...
    const { container } = render(<FileDropzone label="Upload CSV" accept={["text/csv"]} onFiles={onFiles} />);
  ...
  it("rejects files over the max size and does not call onFiles", () => {
    ...
    const { container } = render(
      <FileDropzone label="Upload CSV" accept={["text/csv"]} maxSizeBytes={2} onFiles={onFiles} />,
    );
  ...
  it("renders a drop target region", () => {
    const { container } = render(<FileDropzone label="Upload CSV" onFiles={() => {}} />);
