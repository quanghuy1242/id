...
describe("Container", () => {
  ...
  it("renders content width", () => {
    const { container } = render(<Container width="content">Content</Container>);
...
describe("Panel", () => {
  it("renders with base tone by default", () => {
    ...
    expect(panel).toHaveClass("card", "bg-base-100", "border", "border-base-300");
  });
...
describe("AppShell", () => {
  ...
  it("renders children content", () => {
    render(<AppShell><span data-testid="shell-child">Content</span></AppShell>);
...
describe("MobileDock", () => {
  ...
  it("exposes an accessible navigation label for mobile layouts", () => {
    render(<MobileDock><span>Admin</span></MobileDock>);
    expect(screen.getByRole("navigation", { name: /primary mobile navigation/i })).toHaveClass("lg:hidden");
  });
