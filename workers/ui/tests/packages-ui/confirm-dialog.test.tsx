...
import { ConfirmDialog, TextInput } from "@id/ui";
...
describe("ConfirmDialog", () => {
  ...
  it("uses the danger button variant when requested", () => {
    ...
    expect(screen.getByRole("button", { name: /delete/i })).toHaveClass("btn-error");
  });
  ...
  it("keeps the backdrop dimmed while applying the active theme to the dialog panel", () => {
    ...
    expect(document.querySelector(".modal-box")).toHaveAttribute("data-theme", "lumina-light");
  });
});
