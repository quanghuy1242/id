...
describe("Drawer", () => {
  ...
  it("renders the title and children when open", () => {
    ...
    expect(document.body.querySelector("[data-theme]")).toHaveClass("data-[entering]:animate-drawer-right-in");
  });
  ...
  it("uses a left-side drawer animation when anchored left", () => {
    ...
    expect(document.body.querySelector("[data-theme]")).toHaveClass("data-[entering]:animate-drawer-left-in");
  });
