...
describe("Switch", () => {
  ...
  it("applies toggle-sm for small size", () => {
    ...
    expect(screen.getByRole("switch", { name: /enabled/i })).toHaveClass("toggle-sm");
  });

  it("applies the tone class", () => {
    render(<Switch label="Enabled" tone="success" />);
    expect(screen.getByRole("switch", { name: /enabled/i })).toHaveClass("toggle-success");
  });
