...
CREATE UNIQUE INDEX `oauthClientOrganizationGrant_client_org_resource_uidx` ON `oauthClientOrganizationGrant` (`clientId`,`organizationId`,`resourceServerId`);--> statement-breakpoint
