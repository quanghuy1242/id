...
- User-managed MFA enrollment using Better Auth two-factor, with a clear relationship to Console step-up.
- Verified email change using Better Auth `user.changeEmail`.
