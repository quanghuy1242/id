      ...
      {({ isExpanded }) => (
        ...
        >
          <Heading className="m-0">
            ...
            >
              <span>{title}</span>
              <span className="shrink-0 text-base-content/60" aria-hidden="true">
...
export function DisclosureGroup({ children, allowsMultiple, defaultExpandedKeys }: DisclosureGroupProps) {
  return (
    <AriaDisclosureGroup
