          ...
          {({ close }) => (
            <>
              <div className="flex items-center justify-between border-b border-base-300 px-5 py-4">
                <DialogHeading slot="title" className="text-lg font-bold text-base-content">
                  {title}
                </DialogHeading>
                <Button variant="ghost" size="sm" circle iconName="X" ariaLabel="Close" tooltip="Close" onClick={close} />
              </div>
