  ...
  return (
    <DialogTrigger>
      ...
      <Popover placement={placement} offset={8} className={panelClass}>
        <OverlayArrow>
          <svg width={10} height={10} viewBox="0 0 10 10" className="block fill-base-100 stroke-base-300" aria-hidden="true">
            <path d="M0 0 L5 5 L10 0" />
          </svg>
        </OverlayArrow>
        <Dialog className="outline-none">
          {title ? (
            <Heading slot="title" className="mb-1 text-sm font-semibold text-base-content">
              {title}
            </Heading>
          ) : null}
