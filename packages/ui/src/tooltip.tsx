...
export function Tooltip({ content, placement = "top", delay = 500, children }: TooltipProps) {
  ...
  return (
    <AriaTooltipTrigger delay={delay} closeDelay={0}>
      {children}
      <AriaTooltip offset={8} placement={placement} className={tooltipPanelClass}>
        <OverlayArrow>
          <svg width={8} height={8} viewBox="0 0 8 8" className="block fill-neutral" aria-hidden="true">
