...
const toneClass: Record<ScopePickerTriggerTone, string> = {
  accent: "btn-accent border-accent text-accent hover:border-accent hover:bg-accent/5 hover:text-accent data-[hovered]:bg-accent/5 data-[pressed]:bg-accent/10 focus-visible:outline-accent",
...
export function ScopePickerTrigger({ label, tone, ariaLabel }: ScopePickerTriggerProps) {
  return (
    <AriaButton
      type="button"
